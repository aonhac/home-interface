            ...
            <WebDiv>
                <Flex>
                    ...
                    <div>
                        ...
                        <StyledLi href="https://github.com/ContractChecker" target="_blank">{t('Platform KYC Report')}</StyledLi>
                        <Spacer height="10px" />
                        <StyledLi href="https://github.com/ContractChecker/audits/blob/main/AlaskaInu_Token_0x4689Bf06862d03ab26b77bf53421a362AF80D802_Smart_Contract_Security_Audit_By_ContractChecker.pdf">{t('Platform Safu Report')}</StyledLi>
                    </div>
                    <div>
                        <Text align="center"><b>{t('Social Media')}</b></Text>
                        <Spacer height="10px" />
